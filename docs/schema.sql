...
CREATE TABLE document_file (
    ...
    CONSTRAINT uq_docfile_version UNIQUE (application_id, document_type_id, version_no)
);
...
INSERT INTO alembic_version (version_num) VALUES ('be2a1464a844') RETURNING alembic_version.version_num;
